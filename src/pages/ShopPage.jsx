  ...
  return (
    <>
      ...
      <div className="container">
        ...
        {/* filtri sopra i 576px */}
        <div className="d-flex gap-4">
          <span className="row gx-2 gy-2 flex-grow-1 justify-content-center" style={{ height: "3px" }}>
            {paginatedProducts.map((product) => {
              const isInCompare = compareList.some((p) => p.id === product.id);
              return (
                <div key={product.id} className="col-5 col-sm-4 col-md-4 col-lg-3" style={{ maxHeight: "250px" }}>
          ...
          <span className="flex-column mx-3 h-100 d-none d-sm-flex" style={{ minWidth: "180px" }}>
            {/* Filtro promo */}
            <div className="filter-section">
              <h6 className="mt-3">Solo prodotti in promozione</h6>
              <button
