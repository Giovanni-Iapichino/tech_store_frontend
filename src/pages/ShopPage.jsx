  ...
  return (
    <>
      ...
      <div className="container">
            ...
            {paginatedProducts.map((product) => {
              ...
              return (
                <div key={product.id} className="col-6 col-xl-3 np-product-576">
                  <ProductCardLight product={product} isInCompare={isInCompare} addToCompare={handleCompareClick} removeFromCompare={() => removeFromCompare(product.id)} />
                </div>
              );
            })}
        ...
        {compareError && (
          <div className="alert alert-danger text-center my-2" style={{ maxWidth: 420, margin: "auto" }}>
            {compareError}
          </div>
        )}
