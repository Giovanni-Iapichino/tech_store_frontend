      ...
      <div className="d-flex flex-column justify-content-between gap-2">
        ...
        <div className="d-flex align-items-end gap-1 ms-2">
          <button
            ...
            onClick={() => (isInCart ? (removeFromCart(product.id), showToast("Prodotto rimosso dal carrello")) : (addToCart(product), showToast("Prodotto aggiunto al carrello")))}
          >
            <FontAwesomeIcon
              icon={faCartShopping}
              style={{
          ...
          <button
            ...
            onClick={() =>
              isInWishlist ? (removeFromWishlist(product.id), showToast("Prodotto rimosso dalla lista desideri")) : (addToWishlist(product), showToast("Prodotto aggiunto alla lista desideri"))
            }
          >
            <FontAwesomeIcon
              icon={faHeart}
